    ...
    <div class="flex justify-around">
        ...
        @if (Auth::user()->isManager())
            ...
            <a href="{{ route('manager.approvals.overtime.index') }}"
                class="flex flex-col items-center py-2 px-4 {{ request()->routeIs('manager.approvals.overtime.index') ? 'text-[#3085FE]' : 'text-gray-500' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span class="text-xs mt-1">Overtime</span>
            </a>
            <a href="{{ route('manager.approvals.business-trips.index') }}"
                class="flex flex-col items-center py-2 px-4 {{ request()->routeIs('manager.approvals.business-trips.index') ? 'text-[#3085FE]' : 'text-gray-500' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span class="text-xs mt-1">SPPD</span>
            </a>

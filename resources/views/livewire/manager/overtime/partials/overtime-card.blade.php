        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center space-x-4">
                <div class="relative">
                    ...
                    <div class="absolute -bottom-1 -right-1 h-5 w-5 rounded-full border-2 border-white {{ $this->getStatusColor($overtime->status) }} flex items-center justify-center">
            ...
            @else
                <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium {{ $this->getStatusBadgeColor($overtime->status) }}">

            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900">{{ $overtime->start_time->format('H:i') }} - {{ $overtime->end_time->format('H:i') }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900">{{ $overtime->duration }} Jam</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-900">Rp {{ number_format($overtime->estimated_cost ?? App\Models\Overtime::calculateCost($overtime->duration), 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-green-50 rounded-lg p-3 mb-3">
                        <div class="flex items-center gap-2 text-sm text-green-700">
                            ...
                            <span class="font-medium">
                                Disetujui pada {{ $overtime->approved_at?->format('d M Y, H:i') ?? $overtime->updated_at->format('d M Y, H:i') }}
                ...
                @elseif($overtime->status === App\Models\Overtime::STATUS_CANCELLED)
                    <div class="bg-gray-50 rounded-lg p-3 mb-3">
                        <div class="flex items-center gap-2 text-sm text-gray-700">
                            ...
                            <span class="font-medium">Dibatalkan pada {{ $overtime->updated_at->format('d M Y, H:i') }}</span>
                        </div>
                    </div>
                @endif
            </div>
